<div class="mt-2">
    ...
    <div class="mt-3 flex gap-4 flex-wrap justify-center w-full">
        <h4 class=" w-full bg-gray-50 border-b border-gray-300 text-center font-semibold text-[#5e66f5] p-1">WASHING
            MACHINES,
            STAIRCASE C</h4>

        <h4 class="w-full bg-gray-50 border-b border-gray-300 text-center font-semibold text-[#5e66f5] p-1">FRIDAY
            02.01.2026 >
