<header class="bg-[#5e66f5] text-white p-2 flex justify-between items-center">
    ...
    <img src="/images/logo.png" alt="cannot load" class="w-[200px]" onclick="location.href='{{ route('dashboard') }}'">
    @auth
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6"
            class="text-[#5e66f5] cursor-pointer" onclick="ModalOpen()" id='userIcon'>
        ...
        <div class=" fixed inset-0 z-50 grid place-content-center bg-black/50 p-4" role="dialog" aria-modal="true"
            ...
            <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-lg" id='insideModal'>
                <h2 id="modalTitle" class="text-xl font-bold text-gray-900 sm:text-2xl">User Profile</h2>
                ...
                <div class="mt-4">
                    ...
                    <p class="text-gray-500">CHANGE YOUR PASSWORD</p>
